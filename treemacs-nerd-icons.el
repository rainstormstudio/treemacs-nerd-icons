...
(treemacs-create-theme "emacs-nerd-icons"
  ...
  (progn
    ...
    (treemacs-create-icon :icon (format "%s%s%s%s" (emacs-nerd-icons-octicon "nf-oct-chevron_down"   :face 'treemacs-emacs-nerd-icons-file-face) treemacs-emacs-nerd-icons-tab (emacs-nerd-icons-octicon "file-directory"  :face 'treemacs-emacs-nerd-icons-file-face) treemacs-emacs-nerd-icons-tab)
                          :extensions (dir-open)
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s%s" (emacs-nerd-icons-octicon "nf-oct-chevron_right"   :face 'treemacs-emacs-nerd-icons-file-face) treemacs-emacs-nerd-icons-tab (emacs-nerd-icons-octicon "file-directory"  :face 'treemacs-emacs-nerd-icons-file-face) treemacs-emacs-nerd-icons-tab)
                          :extensions (dir-closed)
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s%s" (emacs-nerd-icons-octicon "nf-oct-chevron_down"   :face 'treemacs-emacs-nerd-icons-file-face) treemacs-emacs-nerd-icons-tab (emacs-nerd-icons-octicon "package"  :face 'treemacs-emacs-nerd-icons-file-face) treemacs-emacs-nerd-icons-tab)
                          :extensions (tag-open)
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "%s%s%s%s" (emacs-nerd-icons-octicon "nf-oct-chevron_right"   :face 'treemacs-emacs-nerd-icons-file-face) treemacs-emacs-nerd-icons-tab (emacs-nerd-icons-octicon "package"  :face 'treemacs-emacs-nerd-icons-file-face) treemacs-emacs-nerd-icons-tab)
